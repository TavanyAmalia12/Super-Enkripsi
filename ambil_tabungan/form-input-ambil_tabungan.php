            ...
            <h2 style="color: #042331; text-align: center ;">Form Ambil Tabungan</h2>
                    ...
                    <tr height="46" style="text-align: left;">
                        ...
                        <tr height="46" style="text-align: left;">
                            <td>&nbsp;</td>
                            <td>Jumlah Ambil</td>
                            <td><span><Input type="text" id="jml_ambil_idr" name="jml_ambil_idr" size="25"></Input></span></td>
                            <td><input type="hidden" name="jml_ambil" id="jml_ambil"></td>
                            <td>&nbsp;</td>
                        </tr>
                    <tr>
                        <td>&nbsp;</td>
                ...
                <input type="submit" class="btn btn-primary" name="Submit" value="Ambil">&nbsp;&nbsp;&nbsp;
