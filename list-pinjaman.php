        ...
        <table width="924" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            ?>
                ...
                <tr align="center" bgcolor="white">
                    ...
                    <td>
                        <?= formatRupiah($pinjaman) ?><div align="center"></div>
                    </td>

                    <td style="background-color: #EEF2F7" ;>
                        <div align="center">
                            <a href="pinjaman/lihat-pinjaman-member.php?id=<?= $id_member ?>">Lihat</a> |
                            <a href="pinjaman/form-input-pinjaman.php?id_member=<?= $id_member ?>">Pinjam</a> |
                            <a href="bayar/form-input-bayar.php?id_member=<?= $id_member ?>">Bayar</a>
                        </div>
                    </td>
                </tr>
            <?php
